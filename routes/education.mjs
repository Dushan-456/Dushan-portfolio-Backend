...
// @access  Public
educationRoutes.get("/", getEducation);

// @route   POST /api/education
// @desc    Create new education record
// @access  Private (Admin)
educationRoutes.post("/", auth, validateEducation, createEducation);

// @route   PUT /api/education/:id
// @desc    Update education record
// @access  Private (Admin)
educationRoutes.put("/:id", auth, validateEducation, updateEducation);

// @route   DELETE /api/education/:id
// @desc    Delete education record (soft delete)
// @access  Private (Admin)
educationRoutes.delete("/:id", auth, deleteEducation);

// @route   POST /api/education/:id/upload-logo
// @desc    Upload institution logo
// @access  Private (Admin)
educationRoutes.post("/:id/upload-logo", auth, uploadSingle("logo"), uploadLogo);
...
// @access  Private (Admin)
educationRoutes.put("/reorder", auth, reorderEducation);

// @route   GET /api/education/admin/all
// @desc    Get all education records (including inactive) for admin
// @access  Private (Admin)
educationRoutes.get("/admin/all", auth, getAllEducation);
